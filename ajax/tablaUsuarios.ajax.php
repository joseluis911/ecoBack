	...
	public function mostrarTabla(){	
		...
		$item = null;
	 	...
	 	for($i = 0; $i < count($usuarios); $i++){
			...
			if($usuarios[$i]["modo"] == "directo" && $usuarios[$i]["foto"] != "" ){

				
              $foto = "<img class='img-circle' src='https://demo.tutiendaenlinea.online/".$usuarios[$i]["foto"]."' width='60px'>";

			}else if ($usuarios[$i]["foto"] == "" ) {
