...
$(".guardarProducto").click(function(){
	...
	if ($(".seleccionarSubCategoria").val() == "") {
		swal({
				title: "No puedes poner una categoria sin subcategoria por favor ve al menú de Categorias y agrega una subcategoria",
				type: "error",
				confirmButtonText: "¡Cerrar!"
			});
	 ...
	 //  $(".seleccionarSubCategoria").val() != "" &&
	   ...
	   $(".pClavesProducto").val() != "" &&
		...
		/*=============================================
	   	...
	   	=============================================*/
				console.log("arrayFiles before: ", arrayFiles.length);
	   	if(tipo != "virtual"){

	   		if(arrayFiles.length > 0 && $(".rutaProducto").val() != ""){
						console.log("arrayFiles after: ", arrayFiles.length);
	   			var listaMultimedia = [];
	   			var finalFor = 0;
					...
					if($("#modalEditarProducto .tituloProducto").val() != "" &&
					   ...
					   $("#modalEditarProducto .pClavesProducto").val() != ""){
						...
						/*=============================================
					   	...
					   	if(tipo != "virtual"){
									console.log("entro a diferente virtual");
